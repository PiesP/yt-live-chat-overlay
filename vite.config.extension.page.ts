/**
 * Vite Configuration for Chrome MV3 Extension — Page Script (IIFE format).
 *
 * Builds the MAIN-world page script that is injected as a <script> tag
 * by the ISOLATED-world content script. Cannot use ES module syntax
 * because it runs in the page's MAIN world.
 *
 * Usage: vite build --config vite.config.extension.page.ts
 */
